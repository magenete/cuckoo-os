...
cuckoo_os_variables()
{
    ...
    CUCKOO_OS_SYSTEM_USER_XFCE4_CONF_DESKTOP_XML_DEFAULT_FILE="${CUCKOO_OS_SYSTEM_USER_XFCE4_CONF_DESKTOP_XML_FILE}.default"
    CUCKOO_OS_SYSTEM_USER_XFCE4_CONF_XSETTINGS_XML_FILE="${CUCKOO_OS_SYSTEM_USER_XFCE4_CONF_XML_DIR}xsettings.xml"
    CUCKOO_OS_SYSTEM_USER_XFCE4_CONF_XSETTINGS_XML_DEFAULT_FILE="${CUCKOO_OS_SYSTEM_USER_XFCE4_CONF_XSETTINGS_XML_FILE}.default"
    CUCKOO_OS_SYSTEM_USER_XFCE4_THEMES_DIR="${HOME}/.themes/"
    CUCKOO_OS_SYSTEM_USER_XFCE4_ICONS_DIR="${HOME}/.icons/"
