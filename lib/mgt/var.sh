...
CUCKOO_OS_SYSTEM_USR_SHARE_LIGHTDM_CUCKOO_DIR="${CUCKOO_OS_SYSTEM_USR_SHARE_LIGHTDM_DIR}${CUCKOO_OS}/"
CUCKOO_OS_SYSTEM_USR_SHARE_LIGHTDM_CONF_DIR="${CUCKOO_OS_SYSTEM_USR_SHARE_LIGHTDM_DIR}lightdm.conf.d/"
CUCKOO_OS_SYSTEM_USR_SHARE_LIGHTDM_CUCKOO_FILE="${CUCKOO_OS_SYSTEM_USR_SHARE_LIGHTDM_CONF_DIR}${CUCKOO_OS}-lightdm.conf"

CUCKOO_OS_SYSTEM_IMAGES_DIR="/usr/share/images/desktop-base/"
CUCKOO_OS_SYSTEM_IMAGES_CUCKOO_DIR="${CUCKOO_OS_SYSTEM_IMAGES_DIR}${CUCKOO_OS}/"
